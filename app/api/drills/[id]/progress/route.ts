...
// GET /api/drills/[id]/progress - Obtener progreso actual
export async function GET(
  ...
  try {
    ...
    const response = await fetch(
      `${process.env.LEAD_BACKEND}/api/v1/drills/${params.id}/progress`,
      {
        headers: {
...
// PUT /api/drills/[id]/progress - Actualizar progreso
